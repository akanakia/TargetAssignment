...
Extending upon our previous work on response threshold based TA in multi-agent systems, we propose the following algorithm to control team-size dynamics at task sites. Each agent 



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Experiments}
We use the Droplet swarm robot platform to perform experiments to study both, the centralized and distributed algorithms mentioned in the previous section.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Discussion of Performance Bounds of Centralized vs.~Distributed Approaches}\label{ref:disc}
