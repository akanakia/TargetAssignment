...
\end{align}
\end{itemize}
Given this problem setup our goal is to maximize the number of successful assignments of agents to targets which in turn maximizes the global welfare while taking into account all agent constraints and target thresholds. Therefore the optimization problem looks something like, $\argmax{X} \We$ which is discussed in considerable detail in the next section.
